...
class UploadHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def _login_page(self, error: str = '') -> str:
       ...
       <style>article.sidebar>p,aside{{display : table-cell ; padding-right : 20px; }}aside{{border:1px solid Black;}} body{{ font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif;}}</style>
        <body>
